...
let g:NvimTreePatternMatchHighlightFullName = 1
let NvimTreeAutoDeleteBuffer = 1
let NvimTreeMinimalUI = 1
let NvimTreeDirArrows = 1
let g:NERDDefaultAlign = 'left'
let g:NERDCustomDelimiters = { 'c': { 'left': '/**','right': '*/' } }
let g:NvimTreeChDirMode=2
let g:NvimTreeIgnore=['\.rbc$', '\~$', '\.pyc$', '\.db$', '\.sqlite$', '__pycache__', 'node_modules']
let g:NvimTreeShowBookmarks=1
